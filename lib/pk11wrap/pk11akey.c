    ...
    *plain = PR_FALSE;
    ...
    switch (tag) {
        ...
        case SEC_OID_CURVE25519:
            ...
            fprintf(stderr, "pk11_get_EC_PointLenInBytes: case SEC_OID_CURVE25519, set plain to true, return 32\n");
            *plain = PR_TRUE;
                         ...
                         const CK_ATTRIBUTE *ecPoint, SECItem *publicKeyValue)
{
    ...
    if (plain && ecPoint->ulValueLen == (unsigned int)keyLen) {
        ...
        fprintf(stderr, "plain is true, this curve is not encoded, copy directly\n");
    ...
    if ((*((char *)ecPoint->pValue) == EC_POINT_FORM_UNCOMPRESSED) &&
        ...
        fprintf(stderr, "pk11_get_Decoded_ECPoint: the point is uncompressed\n");
    ...
    if (*((char *)ecPoint->pValue) == SEC_ASN1_OCTET_STRING) {
        ...
        fprintf(stderr, "pk11_get_Decoded_ECPoint: trying to decode the point\n");
...
PK11_ExtractPublicKey(PK11SlotInfo *slot, KeyType keyType, CK_OBJECT_HANDLE id)
{
    ...
    switch (pubKey->keyType) {
        ...
        case ecKey:
            ...
            fprintf(stderr, "PK11_ExtractPublicKey: case is ecKey\n");
            pubKey->u.ec.size = 0;
            ecparams = attrs;
            ...
            fprintf(stderr, "PK11_ExtractPublicKey calling pk11_get_Decoded_ECPoint\n");
                                ...
                                CK_FLAGS opFlags, CK_FLAGS opFlagsMask, void *wincx)
{
    ...
    if (!PK11_DoesMechanism(slot, type)) {
        ...
        fprintf(stderr, "PK11_DoesMechanism check failed\n");
    ...
    fprintf(stderr, "PK11_DoesMechanism check successful\n");
    ...
    fprintf(stderr, "slot name is %s\n", slot->slot_name);
    fprintf(stderr, "token name is %s\n", slot->token_name);
    fprintf(stderr, "PK11_GenerateKeyPairWithOpFlags is calling C_GenerateKeyPair\n");
