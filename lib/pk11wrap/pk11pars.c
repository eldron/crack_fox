...
{
    fprintf(stderr, "SECMOD_LoadModule is called\n");
    ...
    if(module->functionList == NULL){
        fprintf(stderr, "after SECMOD_CreateModuleEx module->functionList is NULL\n");
    } else {
      fprintf(stderr, "after SECMOD_CreateModuleEx module->functionList is not NULL\n");
    }
